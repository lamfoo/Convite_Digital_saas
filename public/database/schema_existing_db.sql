...
-- For existing database (shared hosting)
...
INSERT IGNORE INTO templates (id, name, category, description, html_content, css_content, thumbnail_url, is_premium) VALUES
(1, 'Elegant Wedding', 'wedding', 'A beautiful and elegant wedding invitation template', 
...
(2, 'Birthday Celebration', 'birthday', 'Fun and colorful birthday party invitation',
...
(3, 'Corporate Event', 'corporate', 'Professional corporate event invitation',
...
(4, 'Baby Shower', 'baby-shower', 'Sweet and gentle baby shower invitation',
...
(5, 'Graduation Party', 'graduation', 'Celebratory graduation party invitation',
